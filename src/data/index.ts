...
export const projects = [
  {
    "id": "1",
    "title": "Zensync",
    "subTitle": "A cloud-based software-as-a-service platform designed to enhance collaboration among users",
    "description": "ZenSync is a cutting-edge collaboration platform designed to redefine teamwork in the digital age. It empowers teams to work together seamlessly in real time, enabling simultaneous document editing, brainstorming on interactive whiteboards, and video conferencing—all within a single, cohesive environment. With AI-powered autocomplete, ZenSync streamlines workflows, saving time and boosting productivity. Its 'work anywhere' design ensures that you can access your tools and documents from any location, while effortless sharing via public URLs enhances collaboration with ease. ZenSync combines simplicity, flexibility, and innovation to help teams achieve more together.",
    ...
    "featured": true,
    "linkedin": "https://www.linkedin.com/posts/ashwin-kv_webdevelopment-zensync-realtimecolaboration-activity-7178428330235293696-akac?utm_source=share&utm_medium=member_desktop",
  ...
  },
  {
    ...
    "linkedin": "https://www.linkedin.com/posts/ashwin-kv_offiq-activity-7124970642424172545-Pore?utm_source=share&utm_medium=member_desktop",
    "features": [
  ...
  },
  {
    ...
    "featured": true,
    "linkedin": "https://www.linkedin.com/posts/ashwin-kv_eatables-fullstackdeveloper-team-activity-7081532144665165824-dbXr?utm_source=share&utm_medium=member_desktop",
    "features": [
  ...
  },
  {
    ...
    "description": "contributed to developing a financial management SaaS tailored for businesses in the UAE market. The platform was designed to simplify accounting processes, automate tax compliance, and provide actionable insights for better decision-making.",
    "image": "https://cdn.prod.website-files.com/634fc8d084a32a7597b0bde8/66d181c13acdaf47452ce590_Finanshels%20Mockup-p-2000.png",
    "tags": [
      "Next.js",
      "Nest.js",
      "PostgreSQL",
  ...
  },
  {
    ...
    "description": "Personal Portfolio built using React.js, TailwindCSS, and TypeScript in a neo-brutalist design. It showcases my skills, projects, and experiences in a clean and modern interface.",
    "image": "https://i.ibb.co/Prmk04j/Screenshot-2024-11-24-at-2-23-11-PM.png",
...
export const posts = [
  {
    ...
    "date": "2024-03-01",
    "excerpt": "Exploring how AI is revolutionizing the way we build websites and applications.",
    "image": "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=400&fit=crop",
    "featured": true,
    "content": [
      {
        "title": "The Rise of AI-Powered Development",
        "text": "Artificial Intelligence is transforming web development at an unprecedented pace. From AI-powered code completion to automated testing and deployment, developers now have access to tools that significantly enhance productivity and code quality. Tools like GitHub Copilot and Amazon CodeWhisperer are leading this revolution, offering intelligent code suggestions and automating repetitive tasks."
      },
      {
        "title": "Impact on Developer Workflow",
        "text": "The integration of AI tools has fundamentally changed how developers approach their work. Automated code review processes, intelligent debugging assistants, and AI-driven performance optimization are becoming standard parts of the development workflow. This shift allows developers to focus more on architecture and creative problem-solving while AI handles routine tasks."
      },
      {
        "title": "Looking Ahead",
        "text": "As AI technology continues to evolve, we can expect even more sophisticated tools that understand context, project requirements, and best practices. The future might bring AI systems capable of generating entire applications from natural language descriptions, while maintaining high standards of security and performance."
      }
    ]
  },
  {
    ...
    "date": "2024-02-15",
    "excerpt": "Tips and techniques for writing effective prompts for AI-powered development.",
    "image": "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=400&fit=crop",
    "featured": false,
    "content": [
      {
        "title": "Understanding Prompt Engineering",
        "text": "Prompt engineering is becoming a crucial skill in the age of AI-assisted development. It involves crafting precise and effective instructions for AI models to generate desired outputs. Whether you're using ChatGPT, GitHub Copilot, or other AI tools, the quality of your prompts directly affects the quality of the results."
      },
      {
        "title": "Key Principles",
        "text": "Effective prompts should be specific, contextual, and structured. Include relevant technical details, desired output format, and any constraints or requirements. Breaking down complex requests into smaller, focused prompts often yields better results."
      },
      {
        "title": "Best Practices",
        "text": "Start with clear objectives, use technical terminology appropriately, and iterate on your prompts based on the results. Include examples when possible, and specify the desired level of detail or abstraction. Remember to validate and review AI-generated code thoroughly."
      }
    ]
  }
];
...
export const education = [
  {
    ...
    "period": "2020 - 2023",
    "description": "• Graduated with a CGPA of 8.16 • Served as Head of Coding Event at Composite 23, a National Level IT Fest • Won First Place at Joshiana 11.0, National Level IT Fest at St. Joseph Engineering College • Won First Place at Noesis 2023, National Level IT Fest at Rosary College"
  },
  {
